 ...
 * @property {Date} indexed - the date when the post was indexed
 * @property {string} blogUrl - the blog URL
 * @property {string} blogName - name of the blog
 * @property {number} authority - the blog's authority/influence (https://developer.twingly.com/resources/search/#authority)
 * @property {number} blogRank - the rank of the blog, based on authority and language (https://developer.twingly.com/resources/search/#authority)
...
/**
 * Sets all instance variables for the Post, given a object
 *
