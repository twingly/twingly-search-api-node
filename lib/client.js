...
Client.prototype.executeQuery = function(query, callback) {
    _getResponse(this, query, function(error, response_body){
...
var _apiKeyMissing = function() {
    throw new TwinglyAuthError('No API key has been provided.');
};

var _envApiKey = function() {
    return process.env.TWINGLY_SEARCH_KEY;
};

var _getResponse = function(client, query, callback) {
