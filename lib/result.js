 ...
 * @property {boolean} incomplete - if this is true, the result could be missing posts as
 *   one or multiple servers failed to respond within the maximum allowed query time.
 *
 * @constructor
 */
var Result = function(){
